      ...
      >
        ...
        >
          <div className="relative aspect-[4/5] w-full overflow-hidden bg-gradient-to-br from-slate-50 to-slate-100">
            ...
            {inCart > 0 && available ? (
              <span
                className="absolute start-2.5 top-2.5 z-10 flex h-6 min-w-6 items-center justify-center rounded-full px-1.5 text-[11px] font-extrabold text-white shadow-lg"
          ...
          <div className="space-y-0.5 p-3.5 pt-3">
            <h3
              className={[
            ...
            <p
              className={[
                ...
                available ? 'text-slate-400' : 'text-slate-400',
              ].join(' ')}
            >
